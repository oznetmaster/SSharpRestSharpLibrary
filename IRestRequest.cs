...
// <<<<< Expansion Methods for Optional Parameters >>>>>
        ...
        /// <param name="path">Full path to file to upload</param>
        /// <returns>This request</returns>
        [DebuggerHidden] IRestRequest AddFile(string name, string path);
        ...
        /// <param name="fileName">The file name to use for the uploaded file</param>
        /// <returns>This request</returns>
        [DebuggerHidden] IRestRequest AddFile(string name, byte[] bytes, string fileName);
        ...
        /// <param name="contentLength">The length (in bytes) of the file content.</param>
        /// <returns>This request</returns>
        [DebuggerHidden] IRestRequest AddFile(string name, Action<Stream> writer, string fileName, long contentLength);
        ...
        /// <param name="filename">The file name to use for the uploaded file</param>
        /// <returns></returns>
        [DebuggerHidden] IRestRequest AddFileBytes(string name, byte[] bytes, string filename);
#endregion
    }
}
