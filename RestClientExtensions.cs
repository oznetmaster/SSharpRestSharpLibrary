...
{ return client.ExecuteTaskAsync<T>(request, Method.PUT).ContinueWith(x => x.Result.Data); }

        [Obsolete("Use HeadAsync")]
        public static Task<T> HeadTaskAsync<T>(this IRestClient client, IRestRequest request) where T : new()
{ return client.ExecuteTaskAsync<T>(request, Method.HEAD).ContinueWith(x => x.Result.Data); }
...
{ return client.ExecuteTaskAsync<T>(request, Method.OPTIONS).ContinueWith(x => x.Result.Data); }

        [Obsolete("Use PatchAsync")]
        public static Task<T> PatchTaskAsync<T>(this IRestClient client, IRestRequest request) where T : new()
{ return client.ExecuteTaskAsync<T>(request, Method.PATCH).ContinueWith(x => x.Result.Data); }

        [Obsolete("Use DeleteAsync")]
        public static Task<T> DeleteTaskAsync<T>(this IRestClient client, IRestRequest request) where T : new()
{ return client.ExecuteTaskAsync<T>(request, Method.DELETE).ContinueWith(x => x.Result.Data); }
#endif
