...
namespace RestSharp
{
    ...
    public class FileParameter
    {
        ...
        public static FileParameter Create(string name, byte[] data, string filename, string contentType) { return new FileParameter
            {
        ...
        public static FileParameter Create(string name, byte[] data, string filename) { return Create(name, data, filename, null); }
        ...
        /// <returns>The <see cref="FileParameter"/> using the default content type.</returns>
        public static FileParameter Create(string name, Action<Stream> writer, long contentLength, string fileName, string contentType /* = null */) { return new FileParameter
            {
                Name = name,
                FileName = fileName,
                ContentType = contentType,
...
// <<<<< Expansion Methods for Optional Parameters >>>>>
        ...
        /// <param name="fileName">The filename to use in the request.</param>
        /// <returns>The <see cref="FileParameter"/> using the default content type.</returns>
        [DebuggerHidden] public static FileParameter Create(string name, Action<Stream> writer, long contentLength, string fileName) {return Create(name, writer, contentLength, fileName, null);}
#endregion
    }
}
