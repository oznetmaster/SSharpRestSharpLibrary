...
namespace RestSharp
	...
	public class RestRequest : IRestRequest
		...
		private IEnumerable<NameValuePair> ParseQuery (string query)
			{
			return
		...
		public IList<DecompressionMethods> AllowedDecompressionMethods
			...
			get
				{
				return _allowedDecompressionMethods.Any ()
		...
		public Action<Stream, IHttpResponse> AdvancedResponseWriter
			{
			get { return _advancedResponseWriter; }
		...
		public IRestRequest AddObject (object obj, params string[] includedProperties)
			...
			var props = type.GetCType().GetProperties ();
		...
		public IRestRequest AddObject (object obj)
			{
			return this.With (x => x.AddObject (obj, new string[] {}));
			}
		...
		public IRestRequest AddParameter (Parameter p)
			{
			return this.With (x => x.Parameters.Add (p));
			}
		...
		public IRestRequest AddParameter (string name, object value)
			{
			return AddParameter (new Parameter (name, value, ParameterType.GetOrPost));
			}
		...
		public IRestRequest AddParameter (string name, object value, ParameterType type)
			{
			return AddParameter (new Parameter (name, value, type));
			}
		...
		public IRestRequest AddParameter (string name, object value, string contentType, ParameterType type)
			{
			return AddParameter (new Parameter (name, value, contentType, type));
			}
		...
		public IRestRequest AddOrUpdateParameter (string name, object value)
			{
			return AddOrUpdateParameter (new Parameter (name, value, ParameterType.GetOrPost));
			}
		...
		public IRestRequest AddOrUpdateParameter (string name, object value, ParameterType type)
			{
			return AddOrUpdateParameter (new Parameter (name, value, type));
			}
		...
		public IRestRequest AddOrUpdateParameter (string name, object value, string contentType, ParameterType type)
			{
			return AddOrUpdateParameter (new Parameter (name, value, contentType, type));
			}
...
// <<<<< Expansion Methods for Optional Parameters >>>>>
		...
		public IRestRequest AddFile (string name, Action<Stream> writer, string fileName, long contentLength)
			{
			return AddFile (name, writer, fileName, contentLength, null);
			}
		...
		public IRestRequest AddFileBytes (string name, byte[] bytes, string filename)
			{
			return AddFileBytes (name, bytes, filename, "application/x-gzip");
			}
