...
// <<<<< Expansion Methods for Optional Parameters >>>>>
        ...
        [DebuggerHidden] public static OAuth1Authenticator ForRequestToken(string consumerKey, string consumerSecret)
        {
        return ForRequestToken(consumerKey, consumerSecret, OAuthSignatureMethod.HmacSha1);
        }

        [DebuggerHidden] public static OAuth1Authenticator ForAccessToken(string consumerKey, string consumerSecret, string token, string tokenSecret)
{
return ForAccessToken(consumerKey, consumerSecret, token, tokenSecret, OAuthSignatureMethod.HmacSha1);
}

        [DebuggerHidden] public static OAuth1Authenticator ForClientAuthentication(string consumerKey, string consumerSecret, string username, string password)
{
return ForClientAuthentication(consumerKey, consumerSecret, username, password, OAuthSignatureMethod.HmacSha1);
}

        [DebuggerHidden] public static OAuth1Authenticator ForProtectedResource(string consumerKey, string consumerSecret, string accessToken, string accessTokenSecret)
{
return ForProtectedResource(consumerKey, consumerSecret, accessToken, accessTokenSecret, OAuthSignatureMethod.HmacSha1);
}
#endregion
    }
}